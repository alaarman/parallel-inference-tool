\begin{minipage}[!]{\mytikzfigurewidth}
    ...
    \begin{tikzpicture}[scale=1.5*\mytikzscale,
        ...
        \begin{scope}[shift={(7,0)},every text node part/.style={align=center}]
            \node[fill=black!15,draw,rectangle,solid,thin,minimum width=70pt,minimum height=55pt]  (compiler) at (0,0)     {\verb+COMPILER+};
        ...
        \begin{scope}[shift={(7,-14)},every text node part/.style={align=center}]
            \node[fill=black!15,draw,rectangle,solid,thin,minimum width=70pt,minimum height=55pt]  (inference) at (0,0)     {\verb+INFERENCE+\\\verb+ENGINE+};

            \node[draw,rectangle,rounded corners,solid,thin,minimum width=65pt,minimum height=\myrectanglesize]  (probs) at (8,0)     {Probabilities};
