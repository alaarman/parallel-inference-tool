...
\section{Parallel Compilation and Inference}\label{sec:parallel}
...
Figure~\ref{fig:frameworkoverview} shows an overview of the underlying principles behind achieving probablistic inference, divided into two steps: \emph{compilation} and \emph{inference}. We will dive into these steps in the following sections.
