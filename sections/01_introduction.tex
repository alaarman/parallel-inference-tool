...
We first go over the preliminaries in Section~\ref{sec:background}. Then, we introduce a high level overview of the theoretical concepts in Section~\ref{sec:parallel} that undely the implementation in Section~\ref{sec:implementation}.
