...
\todo[inline]{
Discuss other tools in more detail (ACE, dlib, etc)
}
...
The effects of different variable orders are known to be crucial in many representation languages. Representations like FBDD~\cite{wegener2000branching}, d-DNNF~\cite{chavira2008probabilistic} and SDD~\cite{darwiche2011sdd}, allow more freedom in the order and could potentially improve the results of \toolname.\todo{we compare already favoray with sdd?}
